...
jest.mock('fs', () => ({readFile: (path: any, options: any, callback: (err: any, data: any) => void) => {
  switch (path) {
    case join(__dirname, '..', '..', '..', '..', '..', 'dist', 'apps', 'web', 'index.html'): callback(null, 'index.html data'); break;
    case join(__dirname, '..', '..', '..', '..', '..', 'dist', 'apps', 'web', 'nodeplotlib.min.js'): callback(null, 'nodeplotlib data'); break;
    case join(__dirname, '..', '..', '..', '..', '..', 'dist', 'apps', 'web', 'plotly.min.js'): callback(null, 'plotly data'); break;
